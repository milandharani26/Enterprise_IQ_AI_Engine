...
async def create_new_service_account(
    ...
    return await service.create_service_account(data=data, org_id=org_id)
...
async def list_all_service_accounts(
    ...
    """
    return await service.list_service_accounts(org_id=org_id)
...
async def revoke_account_access(
    ...
    """
    await service.revoke_service_account(account_id=account_id, org_id=org_id)
...
async def regenerate_account_token(
    ...
    """
    return await service.regenerate_service_account_token(account_id=account_id, data=data, org_id=org_id)
